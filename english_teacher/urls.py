...
urlpatterns = [
    ...
    path('home_work/<int:work_id>', study_home_work, name='studyhomework'),
    path('study_words_first/<int:word_study>', homework_study_words, name='studywords'),
    ...
    path('study_words', self_study_word, name='self_study_words'),
